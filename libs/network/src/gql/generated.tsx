      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              ...
              type: {
                kind: 'NamedType',
                name: { kind: 'Name', value: 'OrderByInput' },
              },
            },
          },
        },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'git_link' } },
                { kind: 'Field', name: { kind: 'Name', value: 'img' } },
                { kind: 'Field', name: { kind: 'Name', value: 'img_laptop' } },
                { kind: 'Field', name: { kind: 'Name', value: 'img_desktop' } },
                { kind: 'Field', name: { kind: 'Name', value: 'img_mobile' } },
                { kind: 'Field', name: { kind: 'Name', value: 'description' } },
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'description_uk' },
                },
